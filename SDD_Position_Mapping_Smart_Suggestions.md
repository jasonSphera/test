...
![C4 Architecture Diagram](images/sdd_c4_architecture.png)
...
![4-Month Implementation Timeline](images/sdd_milestone_timeline.png)
...
![Budget Breakdown by Component](images/sdd_budget_breakdown.png)
...
![Deployment Flow - DEV to Production](images/sdd_deployment_flow.png)
...
![System Overview - Position Filtering Architecture](images/decision_tree_overview_v2.png)
...
![Progressive Filter Reduction - 200 to 3 Positions](images/filter_progression_v2.png)
...
#### 3. Decision Matrix
![Attribute-Based Routing and Branching Logic](images/decision_matrix_v2.png)
...
![Decision Tree: Scope 2 Emissions](images/decision_tree_1_scope2_emissions_v2.png)
...
![Decision Tree: Energy Percentage Calculation](images/decision_tree_2_energy_calculation_v2.png)
...
![Decision Tree: Scope 3 Upstream by Category](images/decision_tree_3_scope3_upstream_v2.png)
